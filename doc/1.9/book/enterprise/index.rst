...
in the ``inventory/localhost/1-bin-tarantool.yml`` file. Shared variables are
...
the Tarantool interpreter, you should unpack the ``bin-tarantool-app.tar.gz``
...
* :ref:`box.info.memory <box_info_memory>`
* :ref:`box.stat <box_introspection-box_stat>`
* :ref:`box.stat.net <box_introspection-box_stat>`
...
.. container:: table
    ...
    +=================+========+======================+===========================================+
    | ``type``        | string | type of event        | .. code-block:: kconfig                   |
    |                 |        |                      |                                           |
    |                 |        |                      |       <“access_denied”>                   |
    +-----------------+--------+----------------------+-------------------------------------------+
    | ``type_id``     | number | id of event          | .. code-block:: kconfig                   |
    |                 |        |                      |                                           |
    |                 |        |                      |       <8>                                 |
    +-----------------+--------+----------------------+-------------------------------------------+
    | ``description`` | string | description of event | .. code-block:: kconfig                   |
    |                 |        |                      |                                           |
    |                 |        |                      |       <“Authentication failed”>           |
    +-----------------+--------+----------------------+-------------------------------------------+
    | ``time``        | string | time of event        | .. code-block:: kconfig                   |
    |                 |        |                      |                                           |
    |                 |        |                      |       <“YYYY-MM-DDTHH:MM:SS.03f[+|-]GMT”> |
    +-----------------+--------+----------------------+-------------------------------------------+
    | ``peer``        | string | remote client        | .. code-block:: kconfig                   |
    |                 |        |                      |                                           |
    |                 |        |                      |      <“ip:port”>                          |
    +-----------------+--------+----------------------+-------------------------------------------+
    | ``user``        | string | user                 | .. code-block:: kconfig                   |
    |                 |        |                      |                                           |
    |                 |        |                      |      <“user”>                             |
    +-----------------+--------+----------------------+-------------------------------------------+
...
.. container:: table
    ...
    +=====================================+=====================+====================================+
    | user authorized successfully        | ``auth_ok``         | .. code-block:: kconfig            |
    |                                     |                     |                                    |
    |                                     |                     |     {“name”: “user”}               |
    +-------------------------------------+---------------------+------------------------------------+
    | user authorization failed           | ``auth_fail``       | .. code-block:: kconfig            |
    |                                     |                     |                                    |
    |                                     |                     |     {“name”: “user”}               |
    +-------------------------------------+---------------------+------------------------------------+
    ...
    |                                     |                     |     “access_type”: “read”}         |
    +-------------------------------------+---------------------+------------------------------------+
    | creating a user                     | ``user_create``     | .. code-block:: kconfig            |
    |                                     |                     |                                    |
    |                                     |                     |     {“name”: “user”}               |
    +-------------------------------------+---------------------+------------------------------------+
    | dropping a user                     | ``user_drop``       | .. code-block:: kconfig            |
    |                                     |                     |                                    |
    |                                     |                     |     {“name”: “user”}               |
    +-------------------------------------+---------------------+------------------------------------+
    | disabling a user                    | ``user_disable``    | .. code-block:: kconfig            |
    |                                     |                     |                                    |
    |                                     |                     |     {“name”: “user”}               |
    +-------------------------------------+---------------------+------------------------------------+
    | enabling a user                     | ``user_enable``     | .. code-block:: kconfig            |
    |                                     |                     |                                    |
    |                                     |                     |     {“name”: “user”}               |
    +-------------------------------------+---------------------+------------------------------------+
    | granting (changing) privileges      | ``user_priv``       | .. code-block:: kconfig            |
    | (roles, profiles, etc.) for the user|                     |                                    |
    |                                     |                     |     {“name”: “user”}               |
    |                                     |                     |     “obj_name”: “obj_name”,        |
    |                                     |                     |     “obj_type”: “space”,           |
    |                                     |                     |     “old_priv”: “”,                |
    |                                     |                     |     “new_priv”: “read,write”}      |
    +-------------------------------------+---------------------+------------------------------------+
    | resetting password of the user (the | ``password_change`` | .. code-block:: kconfig            |
